...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Annotations Basics (The Java&trade; Tutorials &gt;        
...
<div class="nolinkAHEAD">Annotations Basics</div>
...
<div class="linkQUESTIONS"><a href="QandE/questions.html">Questions and Exercises</a></div>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Lesson:</b> Annotations
            ...
            <div class="NavBit">
                <a target="_top" href="index.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="declaring.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>Annotations Basics</h1></div>
            <div id="PageContent">


<h2>The Format of an Annotation</h2>
<p>In its simplest form, an annotation looks like the following:</p>
<div class="codeblock"><pre>
@Entity
</pre></div>
<p>
The at sign character (<code>@</code>) indicates to the compiler that what follows is an annotation. In the following example, the annotation's name is <code>Override</code>:</p>
<div class="codeblock"><pre>
@Override
void mySuperMethod() { ... }
</pre></div>
...
<p>
The annotation can include <em>elements</em>, which can be named or unnamed, and there are values for those elements:</p>
<div class="codeblock"><pre>
@Author(
...
<p>
If the annotation has no elements, then the parentheses can be omitted, as shown in the previous <code>@Override</code> example.</p>
<p>
It is also possible to use multiple annotations on the same declaration:</p>
<div class="codeblock"><pre>
...
<p>
If the annotations have the same type, then this is called a repeating annotation:</p>
<div class="codeblock"><pre>
@Author(name = "Jane Doe")
...
<a class="TutorialLink" target="_top" href="repeating.html">Repeating Annotations</a>.</p>
<p>
The annotation type can be one of the types that are defined in the <code>java.lang</code> or <code>java.lang.annotation</code> packages of the Java SE API. In the previous examples, <code>Override</code> and <code>SuppressWarnings</code> are
<a class="TutorialLink" target="_top" href="predefined.html">predefined Java annotations</a>. It is also possible to define your own annotation type. The <code>Author</code> and <code>Ebook</code> annotations in the previous example are custom annotation types.</p>

<h2>Where Annotations Can Be Used</h2>
<p>
Annotations can be applied to declarations: declarations of classes, fields, methods, and other program elements. When used on a declaration, each annotation often appears, by convention, on its own line.</p>
<p>
As of the Java SE 8 release, annotations can also be applied to the <em>use</em> of types. Here are some examples:</p>
<ul>
...
<p>
This form of annotation is called a <em>type annotation</em>. For more information, see
<a class="TutorialLink" target="_top" href="type_annotations.html">Type Annotations and Pluggable Type Systems</a>.</p>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> Annotations
        <br /><b>Next page:</b> Declaring an Annotation Type
    </div>
</body>
</html> 
