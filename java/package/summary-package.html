...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Summary of Creating and Using Packages (The Java&trade; Tutorials &gt;        
...
<div class="nolinkBHEAD">Summary of Creating and Using Packages</div>
<div class="linkQUESTIONS"><a href="QandE/packages-questions.html">Questions and Exercises</a></div>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Section:</b> Creating and Using Packages
            ...
            <div class="NavBit">
                <a target="_top" href="managingfiles.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="QandE/packages-questions.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>Summary of Creating and Using Packages</h1></div>
            <div id="PageContent">

<!--Summary of Creating and Using Packages-->
<p>To create a package for a type, put a <code>package</code> statement as the first statement in the source file that contains the type (class, interface, enumeration, or annotation type).</p>
<p>To use a public type that&#39;s in a different package, you have three choices: (1) use the fully qualified name of the type, (2) import the type, or (3) import the entire package of which the type is a member.</p>
<p>The path names for a package&#39;s source and class files mirror the name of the package.</p>
<p>You might have to set your <code>CLASSPATH</code> so that the compiler and the JVM can find the <code>.class</code> files for your types.</p>


        </div>
        <div class="NavBit">
            <a target="_top" href="managingfiles.html">&laquo; Previous</a>
            &bull;
            <a target="_top" href="../TOC.html">Trail</a>
            &bull;
            <a target="_top" href="QandE/packages-questions.html">Next &raquo;</a>
        </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> Managing Source and Class Files
        <br /><b>Next page:</b> Questions and Exercises: Creating and Using Packages
    </div>
</body>
</html> 
