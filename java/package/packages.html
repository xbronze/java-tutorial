...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Creating and Using Packages (The Java&trade; Tutorials &gt;        
...
<div class="nolinkAHEAD">Creating and Using Packages</div>
...
<div class="linkQUESTIONS"><a href="QandE/packages-questions.html">Questions and Exercises</a></div>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Lesson:</b> Packages
            ...
            <div class="NavBit">
                <a target="_top" href="index.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="createpkgs.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>Creating and Using Packages</h1></div>
            <div id="PageContent">
...
<div class="note"><hr /><strong>Definition:</strong>&nbsp;A <i>package</i> is a grouping of related types providing access protection and name space management. Note that <i>types</i> refers to classes, interfaces, enumerations, and annotation types. Enumerations and annotation types are special kinds of classes and interfaces, respectively, so <i>types</i> are often referred to in this 
lesson 
 simply as <i>classes and interfaces</i>.
<hr /></div>
...
<li>You can allow types within the package to have unrestricted access to one another yet still restrict access for types outside the package.</li>
        ...
        <div class="NavBit">
            ...
            &bull;
            <a target="_top" href="createpkgs.html">Next &raquo;</a>
        </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> Packages
        <br /><b>Next page:</b> Creating a Package
    </div>
</body>
</html> 
