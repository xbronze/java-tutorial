...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Naming a Package (The Java&trade; Tutorials &gt;        
...
<div class="nolinkBHEAD">Naming a Package</div>
<div class="linkBHEAD"><a href="usepkgs.html">Using Package Members</a></div>
<div class="linkBHEAD"><a href="managingfiles.html">Managing Source and Class Files</a></div>
...
<div class="linkQUESTIONS"><a href="QandE/packages-questions.html">Questions and Exercises</a></div>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Section:</b> Creating and Using Packages
            ...
            <div class="NavBit">
                <a target="_top" href="createpkgs.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="usepkgs.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>Naming a Package</h1></div>
            <div id="PageContent">

<!--Naming a Package-->
<p>With programmers worldwide writing classes and interfaces using the Java programming language, it is likely that many programmers will use the same name for different types. In fact, the previous example does just that: It defines a <code>Rectangle</code> class when there is already a <code>Rectangle</code> class in the <code>java.awt</code> package. Still, the compiler allows both classes to have the same name if they are in different packages. The fully qualified name of each <code>Rectangle</code> class includes the package name. That is, the fully qualified name of the <code>Rectangle</code> class in the <code>graphics</code> package is <code>graphics.Rectangle</code>, and the fully qualified name of the <code>Rectangle</code> class in the <code>java.awt</code> package is <code>java.awt.Rectangle</code>.</p>
<p>This works well unless two independent programmers use the same name for their packages. What prevents this problem? Convention.</p>
...
<td headers="h2"><code>com.example._123name</code></td>
        ...
        <div class="NavBit">
            <a target="_top" href="createpkgs.html">&laquo; Previous</a>
            &bull;
            <a target="_top" href="../TOC.html">Trail</a>
            &bull;
            <a target="_top" href="usepkgs.html">Next &raquo;</a>
        </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> Creating a Package
        <br /><b>Next page:</b> Using Package Members
    </div>
</body>
</html> 
