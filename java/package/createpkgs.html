...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Creating a Package (The Java&trade; Tutorials &gt;        
...
<div class="nolinkBHEAD">Creating a Package</div>
...
<div class="linkQUESTIONS"><a href="QandE/packages-questions.html">Questions and Exercises</a></div>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Section:</b> Creating and Using Packages
            ...
            <div class="NavBit">
                <a target="_top" href="packages.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="namingpkgs.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>Creating a Package</h1></div>
            <div id="PageContent">
...
<div class="note"><hr /><strong>Note:</strong>&nbsp;If you put multiple types in a single source file, only one can be <code>public</code>, and it must have the same name as the source file. For example, you can define <code>public class Circle</code> in the file <code>Circle.java</code>, define <code>public interface Draggable</code> in the file <code>Draggable.java</code>, define <code>public enum Day</code> in the file <code>Day.java</code>, and so forth.<br /><br />
...
<p>If you do not use a <code>package</code> statement, your type ends up in an unnamed package. Generally speaking, an unnamed package is only for small or temporary applications or when you are just beginning the development process. Otherwise, classes and interfaces belong in named packages.</p>
        ...
        <div class="NavBit">
            <a target="_top" href="packages.html">&laquo; Previous</a>
            &bull;
            <a target="_top" href="../TOC.html">Trail</a>
            &bull;
            <a target="_top" href="namingpkgs.html">Next &raquo;</a>
        </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> Creating and Using Packages
        <br /><b>Next page:</b> Naming a Package
    </div>
</body>
</html> 
