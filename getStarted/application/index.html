...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Lesson: A Closer Look at the "Hello World!" Application (The Java&trade; Tutorials &gt; Getting Started)</title>
...
<script type="text/javascript">function search() { var sform = document.getElementById("searchForm"); var srchelem = document.getElementById("searchField"); var srchelemreal = document.getElementById("keywordreal"); var srchval = srchelem.value; if (srchval.length == 0) { return false; } srchelemreal.value = srchval; sform.action = "http://docs.oracle.com/apps/search/search.jsp"; sform.method = "get"; sform.target = "_blank"; sform.submit(); }</script><form id="searchForm" onsubmit="return search()"><input type="hidden" name="category" value="java"/><input type="hidden" name="product" value="e25407-01"/><input type="hidden" name="q" value="" id="keywordreal"/><label for="searchField"><input type="text" id="searchField" size="30" onclick="this.value='';" /></label><input type="submit" value="Search" /></form>                    
    ...
    <div id="LeftBar" class="LeftBar_shown">
        <div id="Contents">
            <div class="nolinkLESSON">A Closer Look at the "Hello World!" Application</div>
</div>
    </div>
    <div id="MainFlow" class="MainFlow_indented">
        ...
        <div class="NavBit">
                <a target="_top" href="../cupojava/index.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="../QandE/questions.html">Next&nbsp;&raquo;</a>
        </div>
        ...
        <div id="PageTitle"><h1>Lesson: A Closer Look at the "Hello World!" Application</h1></div>
        <div id="PageContent">
...
<a class="OutsideLink" target="_blank" href="https://docs.oracle.com/javase/8/docs/technotes/guides/javadoc/index.html">Javadoc&trade; tool documentation</a> .</dd>
<dt><code>// <em>text</em></code></dt>
...
<div class="codeblock"><pre>
java <em>MyApp</em> <em>arg1</em> <em>arg2</em>
</pre></div>
...
<p>uses the <code>System</code> class from the core library to print the &quot;Hello World!&quot; message to standard output. Portions of this library (also known as the &quot;Application Programming Interface&quot;, or &quot;API&quot;) will be discussed throughout the remainder of the tutorial.</p>
    ...
    <div class="NavBit">
        <a href="../cupojava/index.html">&laquo; Previous</a>
        &bull;
        <a href="../TOC.html">Trail</a>
        &bull;
        <a href="../QandE/questions.html">Next &raquo;</a>
    </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Next page:</b> Questions and Exercises: Getting Started
    </div>
</body>
</html> 
