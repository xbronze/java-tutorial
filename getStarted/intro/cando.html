...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>What Can Java Technology Do? (The Java&trade; Tutorials &gt;        
...
<div class="nolinkAHEAD">What Can Java Technology Do?</div>
<div class="linkAHEAD"><a href="changemylife.html">How Will Java Technology Change My Life?</a></div>
    ...
    <div class="PrintHeaders">
        ...
        <br /><b>Lesson:</b> The Java Technology Phenomenon
            ...
            <div class="NavBit">
                <a target="_top" href="definition.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="changemylife.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>What Can Java Technology Do?</h1></div>
            <div id="PageContent">
...
<ul>
<li>
<p><strong>Development Tools</strong>: The development tools provide everything you&#39;ll need for compiling, running, monitoring, debugging, and documenting your applications. As a new developer, the main tools you&#39;ll be using are the <code>javac</code> compiler, the <code>java</code> launcher, and the <code>javadoc</code> documentation tool.</p>
</li>
<li>
<p><strong>Application Programming Interface (API)</strong>: The API provides the core functionality of the Java programming language. It offers a wide array of useful classes ready for use in your own applications. It spans everything from basic objects, to networking and security, to XML generation and database access, and more. The core API is very large; to get an overview of what it contains, consult the 
<a class="OutsideLink" target="_blank" href="https://docs.oracle.com/javase/8/docs/index.html">Java Platform Standard Edition 8 Documentation</a>.</p>
</li>
<li>
<p><strong>Deployment Technologies</strong>: The JDK software provides standard mechanisms such as the Java Web Start software and Java Plug-In software for deploying your applications to end users.</p>
</li>
<li>
<p><strong>User Interface Toolkits</strong>: The JavaFX, Swing, and Java 2D toolkits make it possible to create sophisticated Graphical User Interfaces (GUIs).</p>
</li>
<li>
<p><strong>Integration Libraries</strong>: Integration libraries such as the Java IDL API, JDBC API, Java Naming and Directory Interface (JNDI) API, Java RMI, and Java Remote Method Invocation over Internet Inter-ORB Protocol Technology (Java RMI-IIOP Technology) enable database access and manipulation of remote objects.</p>
</li>
</ul>
        ...
        <div class="NavBit">
            ...
            &bull;
            <a target="_top" href="changemylife.html">Next &raquo;</a>
        </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> About the Java Technology
        <br /><b>Next page:</b> How Will Java Technology Change My Life?
    </div>
</body>
</html> 
