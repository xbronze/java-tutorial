...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>About the Java Technology (The Java&trade; Tutorials &gt;        
...
<script type="text/javascript">function search() { var sform = document.getElementById("searchForm"); var srchelem = document.getElementById("searchField"); var srchelemreal = document.getElementById("keywordreal"); var srchval = srchelem.value; if (srchval.length == 0) { return false; } srchelemreal.value = srchval; sform.action = "http://docs.oracle.com/apps/search/search.jsp"; sform.method = "get"; sform.target = "_blank"; sform.submit(); }</script><form id="searchForm" onsubmit="return search()"><input type="hidden" name="category" value="java"/><input type="hidden" name="product" value="e25407-01"/><input type="hidden" name="q" value="" id="keywordreal"/><label for="searchField"><input type="text" id="searchField" size="30" onclick="this.value='';" /></label><input type="submit" value="Search" /></form>
    ...
    <div id="LeftBar" class="LeftBar_shown">
        <div id="Contents">
            <div class="linkLESSON"><a href="index.html">The Java Technology Phenomenon</a></div>
<div class="nolinkAHEAD">About the Java Technology</div>
<div class="linkAHEAD"><a href="cando.html">What Can Java Technology Do?</a></div>
<div class="linkAHEAD"><a href="changemylife.html">How Will Java Technology Change My Life?</a></div>
</div>
    </div>
    <div id="MainFlow" class="MainFlow_indented">
    <div class="PrintHeaders">
        <b>Trail:</b> Getting Started
        <br /><b>Lesson:</b> The Java Technology Phenomenon
    </div>
            <div id="BreadCrumbs">
                ...
                &gt;
                <a href="index.html" target="_top">The Java Technology Phenomenon</a>
            </div>
            <div class="NavBit">
                <a target="_top" href="index.html">&laquo;&nbsp;Previous</a>&nbsp;&bull;&nbsp;<a target="_top" href="../TOC.html">Trail</a>&nbsp;&bull;&nbsp;<a target="_top" href="cando.html">Next&nbsp;&raquo;</a>
            </div>
            ...
            <div id="PageTitle"><h1>About the Java Technology</h1></div>
            <div id="PageContent">
...
<a class="OutsideLink" target="_blank" href="http://www.oracle.com/technetwork/java/langenv-140151.html"><em>The Java Language Environment</em></a> , a white paper written by James Gosling and Henry McGilton.</p>
<p>In the Java programming language, all source code is first written in plain text files ending with the <code>.java</code> extension. Those source files are then compiled into <code>.class</code> files by the <code>javac</code> compiler. A <code>.class</code> file does not contain code that is native to your processor; it instead contains <em>bytecodes</em> &mdash; the machine language of the Java Virtual Machine<sup><a href="#FOOT">1</a></sup> (Java VM). The <code>java</code> launcher tool then runs your application with an instance of the Java Virtual Machine.</p>
<center><img src="../../figures/getStarted/getStarted-compiler.gif" width="583" height="137" align="bottom" alt="Figure showing MyProgram.java, compiler, MyProgram.class, Java VM, and My Program running on a computer." /></p><p class="FigureCaption">An overview of the software development process.</p></center><p>Because the Java VM is available on many different operating systems, the same <code>.class</code> files are capable of running on Microsoft Windows, the Solaris&trade; Operating System (Solaris OS), Linux, or Mac OS. Some virtual machines, such as the 
<a class="OutsideLink" target="_blank" href="http://www.oracle.com/technetwork/java/javase/tech/index-jsp-136373.html">Java SE HotSpot at a Glance</a>, perform additional steps at runtime to give your application a performance boost. This includes various tasks such as finding performance bottlenecks and recompiling (to native code) frequently used sections of code.</p>
<center><img src="../../figures/getStarted/helloWorld.gif" width="346" height="332" align="bottom" alt="Figure showing source code, compiler, and Java VM's for Win32, Solaris OS/Linux, and Mac OS" /></p><p class="FigureCaption">Through the Java VM, the same application is capable of running on multiple platforms.</p></center><h2>The Java Platform</h2>
...
<a class="TutorialLink" target="_top" href="cando.html">What Can Java Technology Do?</a> highlights some of the functionality provided by the API.</p>
<center><img src="../../figures/getStarted/getStarted-jvm.gif" width="266" height="127" align="bottom" alt="Figure showing MyProgram.java, API, Java Virtual Machine, and Hardware-Based Platform" /></p><p class="FigureCaption">The API and Java Virtual Machine insulate the program from the underlying hardware.</p></center><p>As a platform-independent environment, the Java platform can be a bit slower than native code. However, advances in compiler and virtual machine technologies are bringing performance close to that of native code without threatening portability.</p>
<p><a name="FOOT" id="FOOT">The terms&quot;Java Virtual Machine&quot; and &quot;JVM&quot; mean a Virtual Machine for the Java platform.</a></p>
        ...
        <div class="NavBit">
            ...
            &bull;
            <a target="_top" href="cando.html">Next &raquo;</a>
        </div>
    </div>
...
Copyright &copy; 1995, 2022 Oracle and/or its affiliates. All rights reserved.</a></p>
    ...
    <div class="PrintHeaders">
        <b>Previous page:</b> The Java Technology Phenomenon
        <br /><b>Next page:</b> What Can Java Technology Do?
    </div>
</body>
</html> 
